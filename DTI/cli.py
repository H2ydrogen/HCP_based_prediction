...
def create_parser():
    ...
    parser.add_argument('--INPUT-FEATURES', default=['FA1-mean', 'FA1-max', 'FA1-min', 'FA2-mean', 'Trace1-mean',
                                                     'Trace2-mean', 'Num_Fibers'][0:1], type=list)
    parser.add_argument('--FEATURES-TYPE', default=['right-hemisphere', 'left-hemisphere',
                                                    'commissural', 'anatomical-hemisphere', ][0:1], type=str)
    parser.add_argument('--OUTPUT-FEATURES', default=['sex', 'age', 'race', 'hand', 'BMI'][0], type=str)
    parser.add_argument('--NUM_CLASSES', default=2, type=int)
    parser.add_argument('--FOLD-NUM', default=8, type=int)
    # Network
